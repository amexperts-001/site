...
function applyStatic(l) {
  ...
  document.querySelectorAll('[data-i18n]').forEach(function(el) {
    ...
    /* Pour les <option> : mettre à jour textContent uniquement */
    if (el.tagName === 'OPTION') { el.textContent = d[k]; }
...
(function(global){
  ...
  Object.assign(fr, {
    ...
    part_f_nom_label:'Nom / Organisation *',
    part_f_nom_ph:'Nom de votre organisation',
    part_f_email_label:'Email *',
    part_f_tel_label:'Téléphone',
    part_f_select:'— Sélectionner —',
    part_f_ph_msg:'Présentez votre organisation, votre secteur d\'activité et le type de collaboration envisagé...',
    part_f_btn:'Envoyer la proposition',
    real_cta_p:'Contactez-nous pour discuter de votre projet et obtenir une analyse préliminaire gratuite.',
    real_cta_btn:'Prendre rendez-vous',
  ...
  Object.assign(en, {
    ...
    part_f_nom_label:'Name / Organisation *',
    part_f_nom_ph:'Name of your organisation',
    part_f_email_label:'Email *',
    part_f_tel_label:'Phone',
    part_f_select:'— Select —',
    part_f_ph_msg:'Introduce your organisation, your sector and the type of collaboration envisaged...',
    part_f_btn:'Send proposal',
    real_cta_p:'Contact us to discuss your project and get a free preliminary analysis.',
    real_cta_btn:'Book an appointment',
